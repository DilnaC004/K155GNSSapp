...
import RowWithLabelAndValue from '../Header/RowWithLabelAndValue';
...
export default function useNtrip({getRtcmNtrip}) {
  ...
  const sendGGA = nmeaGGA => {
    client.write(nmeaGGA);
  };

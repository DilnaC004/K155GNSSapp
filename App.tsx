...
export default function App(): JSX.Element {
  // Some test satellites don't exist
  const [nmeaParsed, setNmeaParsed] = useState({
    ...
    "pdop": 1.5,
    "processed": 228,
    "satsActive": [2, 5, 17, 32, 68, 69],
    "satsVisible": [
      { "azimuth": 260, "elevation": 87, "prn": 2, "snr": 41, "status": "tracking", "system": "GPS" },
      { "azimuth": 257, "elevation": 46, "prn": 3, "snr": 39, "status": "tracking", "system": "GPS" },
      { "azimuth": 59, "elevation": 42, "prn": 4, "snr": 24, "status": "tracking", "system": "Galileo" },
      { "azimuth": 192, "elevation": 18, "prn": 5, "snr": 42, "status": "tracking", "system": "Galileo" },
      { "azimuth": 94, "elevation": 57, "prn": 6, "snr": null, "status": "in view", "system": "Galileo" },
      { "azimuth": 183, "elevation": 19, "prn": 8, "snr": 32, "status": "tracking", "system": "Galileo" },
      { "azimuth": 142, "elevation": 58, "prn": 9, "snr": 42, "status": "tracking", "system": "Galileo" },
      { "azimuth": 69, "elevation": 6, "prn": 10, "snr": null, "status": "in view", "system": "BeiDou" },
      { "azimuth": 115, "elevation": 39, "prn": 11, "snr": 19, "status": "tracking", "system": "BeiDou" },
      { "azimuth": 276, "elevation": 7, "prn": 14, "snr": 22, "status": "tracking", "system": "BeiDou" },
      { "azimuth": 314, "elevation": 26, "prn": 17, "snr": 22, "status": "tracking", "system": "BeiDou" },
      { "azimuth": 327, "elevation": 4, "prn": 19, "snr": null, "status": "in view", "system": "BeiDou" },
      { "azimuth": 132, "elevation": 72, "prn": 21, "snr": 45, "status": "tracking", "system": "BeiDou" },
      { "azimuth": 298, "elevation": 12, "prn": 22, "snr": 24, "status": "tracking", "system": "GPS" },
      { "azimuth": 341, "elevation": 6, "prn": 27, "snr": null, "status": "in view", "system": "GPS" },
      { "azimuth": 96, "elevation": 17, "prn": 28, "snr": null, "status": "in view", "system": "GPS" },
      { "azimuth": 127, "elevation": 5, "prn": 31, "snr": 20, "status": "tracking", "system": "GPS" },
      { "azimuth": 52, "elevation": 33, "prn": 32, "snr": 22, "status": "tracking", "system": "GPS" },
      { "azimuth": 171, "elevation": 33, "prn": 36, "snr": 42, "status": "tracking", "system": "Galileo" },
      { "azimuth": 134, "elevation": 23, "prn": 40, "snr": 32, "status": "tracking", "system": "Galileo" },
      { "azimuth": 108, "elevation": 6, "prn": 41, "snr": null, "status": "in view", "system": "Galileo" },
      { "azimuth": 195, "elevation": 32, "prn": 49, "snr": 44, "status": "tracking", "system": "Galileo" },
      { "azimuth": 37, "elevation": 0, "prn": 66, "snr": 5, "status": "tracking", "system": "GLONASS" },
      { "azimuth": 41, "elevation": 49, "prn": 67, "snr": 28, "status": "tracking", "system": "GLONASS" },
      { "azimuth": 201, "elevation": 75, "prn": 68, "snr": 47, "status": "tracking", "system": "GLONASS" },
      { "azimuth": 213, "elevation": 23, "prn": 69, "snr": 34, "status": "tracking", "system": "GLONASS" }],
    "speed": 0.112972,
